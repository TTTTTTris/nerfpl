...
def get_opts():
    ...
    parser.add_argument('--task_dir', type=str, default='./DataSet/data', help='root directory of tasks') 
    parser.add_argument('--root_dir', type=str, default='./DataSet/data', help='root directory of dataset') 

    parser.add_argument('--operator', type=str, default='add', help='fit, add, sub, mul, div, ln, etc') 
    parser.add_argument('--modelType', type=str, default='SIREN', help='MLP, MLP+PE, SIREN') 
    ...
    parser.add_argument('--img_wh', nargs="+", type=int, default=[178, 178], help='resolution (img_w, img_h) of the image')
    parser.add_argument('--ctf_wh', nargs="+", type=int, default=[178, 178], help='resolution (ctf_w, ctf_h) of the CTF')
